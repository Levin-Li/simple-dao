...
public abstract class JniHelper {
    ...
    public static String readFileAsText(String fileName) {
        ...
        return data != null ? new String(data, Charset.forName(UTF_8)) : null;
    }
     ...
     * @return
     */
    public static long writeFile(String fileName, boolean isAppend, String content) {
        return writeFile(fileName, isAppend, content.getBytes(Charset.forName(UTF_8)));
    }

    /**
     * @param fileName
     * @param content
     * @return 写入后的文件大小，-1 表示写入错误
     */
    public static long writeFile(String fileName, boolean isAppend, byte[] content) {

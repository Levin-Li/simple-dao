...
public class DeleteDaoImpl<T>
    ...
    protected DeleteDaoImpl(boolean isNative, JpaDao dao) {
        super(isNative);
        this.dao = dao;
    }

    public DeleteDaoImpl(JpaDao dao, Class<T> entityClass, String alias) {
        super(entityClass, alias);
        this.dao = dao;
    }

    public DeleteDaoImpl(JpaDao dao, String tableName, String alias) {

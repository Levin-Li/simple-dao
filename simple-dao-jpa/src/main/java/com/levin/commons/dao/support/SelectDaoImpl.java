...
public class SelectDaoImpl<T>
    ...
    public SelectDaoImpl(boolean isNative, JpaDao dao) {
        super(isNative);
        this.dao = dao;
    }

    public SelectDaoImpl(JpaDao dao, boolean isNative, String fromStatement) {
    ...
    public SelectDaoImpl(JpaDao dao, String tableName, String alias) {
        super(tableName, alias);
        this.dao = dao;
    }

    public SelectDaoImpl(JpaDao dao, Class<T> entityClass, String alias) {
...
//    @Override
    ...
    public <E> List<E> find(Class<E> targetType, int maxCopyDeep, String... ignoreProperties) {
        ...
        boolean isEntity = (targetType.isAnnotationPresent(Entity.class));

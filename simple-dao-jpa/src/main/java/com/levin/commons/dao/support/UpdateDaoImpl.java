...
public class UpdateDaoImpl<T>
    ...
    protected UpdateDaoImpl(boolean isNative, JpaDao dao) {
        super(isNative);
        this.dao = dao;
    }

    public UpdateDaoImpl(JpaDao dao, Class<T> entityClass, String alias) {
        super(entityClass, alias);
        this.dao = dao;
    }

    public UpdateDaoImpl(JpaDao dao, String tableName, String alias) {

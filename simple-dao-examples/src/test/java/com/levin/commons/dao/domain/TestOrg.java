 ...
 * 示例代码
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年8月6日 下午5:17:53, 代码生成哈希校验码：[c91fe72486263727b40105472e3c14d5]，请不要修改和删除此行内容。
 */
@Data
...
// @Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class TestOrg extends AbstractTreeObject<String, TestOrg>
